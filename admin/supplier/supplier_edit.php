                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Form Edit Supplier</h3>
                                </div>
                                <?php
                                ...
                                <div class="panel-body">
                                    <form action="supplier_update.php" method="post" enctype="multipart/form-data"
                                        ...
                                        <input type="hidden" value="<?php echo"$dt[id_supplier]" ?>" name="id_supplier">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label" style="font-size: 14px;text-align:start;">ID Supplier :</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="id_supplier" value="<?php echo"$dt[id_supplier]" ?>"
                                                       disabled>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="nama_supplier"
                                                       value="<?php echo"$dt[nama_supplier]" ?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
